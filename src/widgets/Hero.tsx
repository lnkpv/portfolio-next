  ...
  return (
    <div id="home" className={className}>
      <div className="h-[90vh] w-full relative flex items-center">
        ...
        <div className="pointer-events-none relative backdrop-blur-2xl bg-background/20 rounded-2xl px-20 pt-20 pb-12 m-auto max-w-[70vw] w-full flex flex-col gap-3 justify-center text-md md:text-xl z-[2]">
        ...
        <div className="absolute h-[55vh] w-full top-1/2 -translate-y-1/2 opacity-60 z-1">
          <LiquidChrome
            baseColor={[

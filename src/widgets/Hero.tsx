  ...
  return (
    <div id="home" className={className}>
      ...
      <div ref={start} className="h-[80vh] w-full relative flex items-center">
        ...
        <div className="pointer-events-none relative backdrop-blur-2xl bg-background/30 rounded-2xl px-20 pt-20 pb-12 m-auto max-w-[70vw] w-full flex flex-col gap-3 justify-center text-md md:text-xl z-50">

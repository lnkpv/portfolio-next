...
import { Button } from "@/shared/components/magicui/button";
import { ScrollArea } from "@/shared/components/magicui/scroll-area";
    ...
    return (
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(
            `flex items-center gap-1 rounded-md text-md`,
            className,
            {
  ...
  (
    ...
    return (
      <button
        ...
        disabled={!isSelectable}
        className={cn(
          "flex w-fit items-center gap-1 rounded-md pr-1 text-md duration-200 ease-in-out rtl:pl-1 rtl:pr-0",
          {

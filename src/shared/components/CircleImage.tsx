...
function CircleImage({ type = "hero" }: { type?: "hero" | "contacts" }) {
  const style =
    type === "hero"
      ? "absolute -left-[5vw] sm:left-[0vw] md:left-[5vw] -top-[20vh] sm:-top-[14vh] md:-top-[20vh] lg:-top-[15vh] xl:-top-[150px] size-[155px] scale-60 sm:scale-75 md:scale-100 rounded-full z-[999]"
